...
public class PaymentMethod {
  ...
  @NotNull private PaymentMethodGroup group;
  @NotNull private Map<Language, String> name;
  @NotNull private Map<Language, String> description;
  ...
  @NotNull private PaymentMethodStatus status;
