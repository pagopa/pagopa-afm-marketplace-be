...
/**
 * Converter class that specify how to convert a {@link CiBundle} instance to a {@link
 * CiBundleDetails} instance
 */
public class ConvertCIBundleTCIBundleDetails implements Converter<CiBundle, CiBundleDetails> {
  ...
  private List<CiBundleAttribute> convertAttributes(
      List<it.pagopa.afm.marketplacebe.entity.CiBundleAttribute> attributes) {
