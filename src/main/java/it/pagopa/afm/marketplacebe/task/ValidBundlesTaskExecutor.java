...
public class ValidBundlesTaskExecutor extends TaskExecutor {
    ...
    private void generateConfiguration() {
        ...
        List<ValidBundle> validBundleList = bundles.parallelStream().map(bundle -> {
            ...
            validBundle.setDigitalStamp(bundle.getDigitalStamp() != null ? bundle.getDigitalStamp() : Boolean.FALSE);
            validBundle.setDigitalStampRestriction(bundle.getDigitalStampRestriction() != null ? bundle.getDigitalStampRestriction() : Boolean.FALSE);
            return validBundle;
