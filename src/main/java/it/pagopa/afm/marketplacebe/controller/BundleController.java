...
public class BundleController {
  ...
  public ResponseEntity<Bundles> getGlobalBundles(
      @Parameter(description = "Bundle's type")
      ...
      @Parameter(
              description =
                  "Validity date of bundles, used to retrieve all bundles valid from the specified"
                      + " date (yyyy-MM-dd)",
              example = "2024-05-10")
      ...
      @Parameter(
              description =
                  "Validity date of bundles, used to retrieve all bundles that expire at the"
                      + " specified date (yyyy-MM-dd)",
              example = "2024-05-10")
          @RequestParam(required = false)
          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          LocalDate expireAt,
      @Parameter(description = "Only Active Bundle", example = "true")
          @RequestParam(required = false)
          Boolean active,
    ...
    return ResponseEntity.ok(
        this.bundleService.getBundles(types, name, validFrom, expireAt, active, limit, page));
  }
