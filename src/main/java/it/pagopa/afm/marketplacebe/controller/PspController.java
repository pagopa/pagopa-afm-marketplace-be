...
public class PspController {
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = Bundles.class))),
        @ApiResponse(
            responseCode = "400",
  ...
  public ResponseEntity<Bundles> getBundles(
      @Size(max = 35)
          ...
          @PathVariable("idpsp")
          String idPsp,
      @Parameter(description = "Bundle type. Default = GLOBAL")
          @RequestParam(required = false, defaultValue = "GLOBAL")
          @Valid
          List<BundleType> types,
      @Parameter(description = "Bundle name.") @RequestParam(required = false) @Valid String name,
      @Parameter(description = "Order bundles by maxPaymentAmount", example = "ASC")
          @RequestParam(required = false)
          Sort.Direction maxPaymentAmountOrder,
      @Parameter(description = "Filter bundles with paymentAmount less than")
          @RequestParam(required = false)
          Long paymentAmountMinRange,
      @Parameter(description = "Filter bundles with paymentAmount more than")
          @RequestParam(required = false)
          Long paymentAmountMaxRange,
      @Parameter(
              description =
                  "Validity date of bundles, used to retrieve all bundles valid before the"
      ...
      @Parameter(
              description =
                  "Validity date of bundles, used to retrieve all bundles valid after the specified"
                      + " date (yyyy-MM-dd)",
              example = "2024-05-10")
          @RequestParam(required = false)
          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
      ...
      @Parameter(
              description =
                  "Validity date of bundles, used to retrieve all bundles that expire before the"
                      + " specified date (yyyy-MM-dd)",
              example = "2024-05-10")
          @RequestParam(required = false)
          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
      ...
      @Parameter(
              description =
                  "Validity date of bundles, used to retrieve all bundles that expire after the"
                      + " specified date (yyyy-MM-dd)",
              example = "2024-05-10")
          @RequestParam(required = false)
          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
      ...
      @Positive
          @Parameter(description = "Number of items for page. Default = 50")
          @RequestParam(required = false, defaultValue = "50")
          Integer limit,
      @PositiveOrZero
          @Parameter(description = "Page number. Page number value starts from 0. Default = 0")
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = PspBundleDetails.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = BundleCreditorInstitutionResource.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  public ResponseEntity<BundleCreditorInstitutionResource> getBundleCreditorInstitutions(
      ...
      @Parameter(description = "Bundle identifier", required = true) @PathVariable("idbundle")
          String idBundle,
      @Parameter(description = "CI fiscal code") @RequestParam(required = false) @Valid
          String ciFiscalCode,
      @Parameter(description = "Number of items for page")
          @RequestParam(required = false, defaultValue = "50")
          @Positive
          @Max(200)
          Integer limit,
  ...
  /**
   * GET /psps/:idpsp/bundle/:idbundle/creditorInstitutions/:cifiscalcode : Get details of a
   * relationship between a bundle and a creditor institution
   *
   * @param idPsp : PSP identifier
   * @param idBundle : Bundle identifier
      ...
      value = {
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = CiBundleDetails.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  public ResponseEntity<CiBundleDetails> getBundleCreditorInstitutionDetails(
      ...
      @Parameter(description = "Bundle identifier", required = true) @PathVariable("idbundle")
          String idBundle,
      @Parameter(description = "Bundle identifier", required = true) @PathVariable("cifiscalcode")
          String ciFiscalCode) {
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = BundleResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  public ResponseEntity<BundleResponse> createBundle(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(bundleService.createBundle(idPsp, bundleRequest));
  }
  ...
  public ResponseEntity<List<BundleResponse>> createBundleByList(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(bundleService.createBundleByList(idPsp, bundleRequestList));
  }
  ...
  public ResponseEntity<Void> updateBundle(
      ...
      @Parameter(description = "Bundle identifier", required = true) @PathVariable("idbundle")
          String idBundle,
      @Parameter(description = "Force update")
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = BundleOffers.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  public ResponseEntity<BundleOffers> getOffers(
      @Parameter(description = "PSP identifier", required = true)
          ...
          @Size(max = 35)
          String idPsp,
      @Parameter(description = "Filter by creditor institution") @RequestParam(required = false)
          String ciTaxCode,
      @Parameter(description = "Filter by bundle id") @RequestParam(required = false)
          String idBundle,
      @Parameter(description = "Number of items for page")
          @RequestParam(required = false, defaultValue = "50")
          @Positive
      ...
      @Parameter(description = "Page number")
          ...
          Integer page) {
    return ResponseEntity.ok(
        bundleOfferService.getPspOffers(idPsp, ciTaxCode, idBundle, limit, page));
  }

  /**
   * POST /psps/:idpsp/bunldes/:idbundle/offers : PSP offers a private bundle to a creditor
   * institution
   *
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    array = @ArraySchema(schema = @Schema(implementation = BundleOffered.class)))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  public ResponseEntity<List<BundleOffered>> sendBundleOffer(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(bundleOfferService.sendBundleOffer(idPsp, idBundle, ciFiscalCodeList));
  }

  /**
   * DELETE /psps/:idpsp/bunldes/:idbundle/offers/:idbundleoffer : PSP deletes a private bundle
   * offered
   *
   * @param idPsp PSP identifier.
   * @param idBundle Bundle identifier.
  ...
  public ResponseEntity<Void> removeBundleOffer(
      ...
      @Parameter(description = "Bundle identifier", required = true) @PathVariable("idbundle")
          String idBundle,
      @Parameter(description = "Bundle offer identifier", required = true)
          @PathVariable("idbundleoffer")
  ...
  /**
   * GET /psps/:idpsp/requests : Get paginated list of CI requests to the PSP regarding public
   * bundles
   *
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = PublicBundleRequests.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  @PostMapping(value = "/{idpsp}/requests/{idBundleRequest}/accept")
  public ResponseEntity<Void> acceptRequest(
      @Size(max = 35)
          @Parameter(description = "PSP identifier", required = true)
          @PathVariable("idpsp")
          String idPsp,
      @Parameter(description = "Bundle Request identifier", required = true)
          @PathVariable("idBundleRequest")
          String idBundleRequest) {
  ...
  @PostMapping(value = "/{idpsp}/requests/{idBundleRequest}/reject")
