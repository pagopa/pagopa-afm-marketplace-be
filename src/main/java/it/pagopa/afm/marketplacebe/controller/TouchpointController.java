...
public class TouchpointController {
  ...
  @Autowired private TouchpointService touchpointService;
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = Touchpoints.class))),
        @ApiResponse(
            responseCode = "400",
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = Touchpoint.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  public Touchpoint getTouchpoint(
      @Parameter(description = "Touchpoint identifier", required = true) @PathVariable("id")
          String id) {
  ...
  public ResponseEntity<Touchpoint> createTouchpoint(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(touchpointService.createTouchpoint(touchpointRequest));
  }
