...
public class HomeController {
    ...
    public Bundles getGlobalBundles(
        ...
        return this.bundleService.getBundles(types, name, validFrom, limit, page);
    }
     ...
     */
    @Operation(summary = "Get the bundle details", security = {@SecurityRequirement(name = "ApiKey")}, tags = {"CI",})
    @ApiResponses(value = {
