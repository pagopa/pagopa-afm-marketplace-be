...
public class CiController {
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = CiBundles.class))),
        @ApiResponse(
            responseCode = "400",
  ...
  public CiBundles getBundlesByFiscalCode(
      @Parameter(description = "Creditor institution's tax code", required = true)
          @PathVariable("ci-fiscal-code")
          String ciTaxCode,
      @Parameter(description = "Filtering the ciBundles by type") @RequestParam(required = false)
          BundleType type,
      @Parameter(description = "Filtering the ciBundles by bundle name")
          @RequestParam(required = false)
          String bundleName,
      @Parameter(
              description =
                  "Filtering the ciBundles by pspBusinessName of the corresponding bundle")
          @RequestParam(required = false)
      ...
      @Parameter(description = "Page number")
          ...
          @PositiveOrZero
          Integer page) {
    return bundleService.getBundlesByFiscalCode(
        ciTaxCode, type, bundleName, pspBusinessName, limit, page);
  }
  ...
  public CiBundleDetails getBundleByFiscalCode(
      @Parameter(description = "Creditor institution's tax code", required = true)
          @PathVariable("ci-fiscal-code")
          String fiscalCode,
      @Parameter(description = "Bundle identifier", required = true) @PathVariable("id-bundle")
          String idBundle) {
  ...
  public ResponseEntity<Void> removeBundleByFiscalCode(
      @Parameter(description = "CI identifier", required = true) @PathVariable("ci-fiscal-code")
          String fiscalCode,
      @Parameter(description = "CIBundle identifier", required = true) @PathVariable("idcibundle")
          String idCiBundle) {
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = BundleDetailsAttributes.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = BundleAttributeResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  public ResponseEntity<BundleAttributeResponse> createBundleAttributesByCi(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(bundleService.createBundleAttributesByCi(fiscalCode, idBundle, bundleAttribute));
  }
  ...
  public ResponseEntity<Void> updateBundleAttributesByCi(
      ...
      @Parameter(description = "Bundle identifier", required = true) @PathVariable("id-bundle")
          String idBundle,
      @Parameter(description = "Attribute identifier", required = true) @PathVariable("idattribute")
          String idAttribute,
      @RequestBody @Valid @NotNull CiBundleAttributeModel bundleAttribute) {
  ...
  /**
   * GET /cis/:ci-fiscal-code/requests : Get paginated list of CI requests to the PSP regarding
   * public bundles
   *
  ...
  public ResponseEntity<PublicBundleRequests> getRequestsByCI(
      @Parameter(description = "Creditor institution's tax code", required = true)
          @PathVariable("ci-fiscal-code")
          String ciFiscalCode,
      @Parameter(description = "Filter by psp identifier")
          @RequestParam(required = false)
          @Size(max = 35)
          String idPsp,
    ...
    return ResponseEntity.ok(
        bundleRequestService.getPublicBundleRequests(idPsp, limit, page, ciFiscalCode, idBundle));
  }
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = BundleRequestId.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  public ResponseEntity<BundleRequestId> createRequest(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(bundleRequestService.createBundleRequest(ciFiscalCode, ciBundleSubscriptionRequest));
  }

  /**
   * DELETE /cis/:ci-fiscal-code/requests/:id-bundle-request : Delete CI request regarding public
   * bundles
   *
   * @param ciFiscalCode CI identifier.
   * @return OK. (status code 200) or Service unavailable (status code 500)
  ...
  public ResponseEntity<Void> removeRequest(
      @Parameter(description = "CI identifier", required = true) @PathVariable("ci-fiscal-code")
          String ciFiscalCode,
      @Parameter(description = "CI identifier", required = true) @PathVariable("id-bundle-request")
  ...
  /**
   * GET /cis/:ci-tax-code/offers : Get paginated list of PSP offers to the CI regarding private
   * bundles
   *
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = BundleCiOffers.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
  ...
  public ResponseEntity<BundleCiOffers> getOffersByCI(
      @Parameter(
              description =
                  "Tax code of the creditor institution to which the offers are addressed",
              required = true)
          @PathVariable("ci-fiscal-code")
          String ciTaxCode,
      @Parameter(
              description =
                  "Id of the payment service provider that has created the offers (used for to"
                      + " filter out the result)")
          @RequestParam(required = false)
          String idPsp,
      @Parameter(description = "Filtering the offers by bundle name")
          @RequestParam(required = false)
          String bundleName,
      @Parameter(description = "Number of items for page")
          @RequestParam(required = false, defaultValue = "50")
      ...
      @Parameter(description = "Page number")
          ...
          Integer page) {
    return ResponseEntity.ok(
        this.bundleOfferService.getCiOffers(ciTaxCode, idPsp, bundleName, limit, page));
  }
      ...
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = MediaType.APPLICATION_JSON_VALUE,
                    schema = @Schema(implementation = CiBundleId.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Bad Request",
            content =
