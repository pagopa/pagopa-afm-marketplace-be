...
public class PaymentMethodsItem {
  ...
  @NotNull Map<Language, String> name;
  @NotNull Map<Language, String> description;
  @NotNull PaymentMethodStatus status;
  @NotNull LocalDate validityDateFrom;
  @NotNull PaymentMethodGroup group;
  @NotNull FeeRange feeRange;
  @NotNull String paymentMethodAsset;
  @NotNull MethodManagement methodManagement;
