...
//    }
    ...
    void createBundle_ok_9() {
        // same (payment method, touchpoint, transferCategoryList, payment amount range), different idChannel
        BundleRequest bundleRequest = TestUtil.getMockBundleRequest();
    ...
    void createBundle_ko_12() {
        // Same bundle configuration for two bundle (1 ONUS, 1 NOT ONUS) with different idChannel.
        BundleRequest bundleRequest = TestUtil.getMockBundleRequest();
        List<Bundle> bundles = TestUtil.getMockBundleSameConfiguration();
