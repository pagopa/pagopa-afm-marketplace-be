...
import it.pagopa.afm.marketplacebe.model.paymentmethods.enums.PaymentMethodType;
...
class PaymentMethodsServiceTest {
  ...
  @Autowired @InjectMocks PaymentMethodsService paymentMethodsService;

  @MockBean CosmosTemplate cosmosTemplate;

  @MockBean PaymentMethodRepository paymentMethodRepository;
  ...
  void getPaymentMethod() {
    when(paymentMethodRepository.findByPaymentMethodId(anyString()))
        .thenReturn(
            List.of(
                PaymentMethod.builder()
                    .paymentMethodId("PAYPAL")
