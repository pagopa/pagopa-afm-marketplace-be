...
public class TestUtil {
  ...
  public static CiBundleInfo getMockCiBundleInfo() {
    ...
    return CiBundleInfo.builder().build();
  }

  public static CiBundles getMockCiBundles() {
    List<CiBundleDetails> list = List.of(getMockCiBundleDetails());

    PageInfo pageInfo = PageInfo.builder().itemsFound(list.size()).totalPages(1).build();

    return CiBundles.builder().bundleDetailsList(list).pageInfo(pageInfo).build();
  }
  ...
  public static CiFiscalCodeList getMockCiFiscalCodeList() {
    return CiFiscalCodeList.builder().ciFiscalCodeList(List.of(getMockCiFiscalCode())).build();
  }
  ...
  public static BundleCreditorInstitutionResource getMockBundleCreditorInstitutionResource() {
    ...
    return BundleCreditorInstitutionResource.builder()
        ...
        .pageInfo(PageInfo.builder().itemsFound(mockCiFiscalCode.size()).totalPages(1).build())
        .build();
  }
  ...
  public static CiBundleDetails getMockCiBundleDetails() {
    ...
    it.pagopa.afm.marketplacebe.model.bundle.CiBundleAttribute attributeM =
        modelMapper.map(
            attributeE, it.pagopa.afm.marketplacebe.model.bundle.CiBundleAttribute.class);
  ...
  public static Bundles getMockBundles() {
    ...
    PageInfo pageInfo = PageInfo.builder().itemsFound(bundleList.size()).totalPages(1).build();
    return Bundles.builder().bundleDetailsList(bundleList).pageInfo(pageInfo).build();
  }

  public static BundleResponse getMockBundleResponse() {
    return BundleResponse.builder().idBundle(getMockIdBundle()).build();
  }

  public static List<BundleResponse> getMockBundleResponseList() {
    return Arrays.asList(
        BundleResponse.builder().idBundle(getMockIdBundle()).build(),
        BundleResponse.builder().idBundle(getMockIdBundle()).build(),
        BundleResponse.builder().idBundle(getMockIdBundle()).build());
  }
  ...
  public static BundleOffers getMockBundleOffers() {
    ...
    PageInfo pageInfo = PageInfo.builder().itemsFound(offers.size()).totalPages(1).build();
    return BundleOffers.builder().offers(offers).pageInfo(pageInfo).build();
  }

  public static List<BundleOffer> getMockBundleOfferList() {
    return List.of(getMockBundleOffer());
  }
  ...
  public static PublicBundleRequests getMockPublicBundleRequests() {
    ...
    return PublicBundleRequests.builder().requestsList(list).pageInfo(pageInfo).build();
  }

  public static BundleRequestId getMockBundleRequestId() {
    return BundleRequestId.builder().idBundleRequest(UUID.randomUUID().toString()).build();
  }
  ...
  public static BundleCiOffers getMockBundleCiOffers() {
    ...
    PageInfo pageInfo = PageInfo.builder().itemsFound(list.size()).totalPages(1).build();
    return BundleCiOffers.builder().offers(list).pageInfo(pageInfo).build();
  }

  public static CiBundleId getMockCiBundleId() {
    return CiBundleId.builder().id(UUID.randomUUID().toString()).build();
  }
  ...
  public static Iterable<Touchpoint> getMockTouchpoints() {
    return List.of(
        getMockTouchpoint("IO"), getMockTouchpoint("CHECKOUT"), getMockTouchpoint("WISP"));
  }

  public static it.pagopa.afm.marketplacebe.entity.Touchpoint getMockTouchpointRequest() {
    return it.pagopa.afm.marketplacebe.entity.Touchpoint.builder().name("IO").build();
  }
