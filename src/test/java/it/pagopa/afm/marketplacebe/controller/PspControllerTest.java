...
class PspControllerTest {
    ...
    void getBundles_200() throws Exception {
        when(bundleService.getBundlesByIdPsp(anyString(), anyList(), any(), any(), any(), any(), anyInt(), anyInt())).thenReturn(TestUtil.getMockBundles());
    ...
    void getBundles_404() throws Exception {
        ...
        doThrow(exception).when(bundleService).getBundlesByIdPsp(anyString(), anyList(), any(), any(), any(), any(), anyInt(), anyInt());
