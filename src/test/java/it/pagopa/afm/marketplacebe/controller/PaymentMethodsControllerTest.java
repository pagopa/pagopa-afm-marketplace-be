...
class PaymentMethodsControllerTest {
  ...
  @MockBean PaymentMethodsService paymentMethodsService;
  ...
  void getPaymentMethods() throws Exception {
    ...
    mvc.perform(get("/payment-methods").contentType(MediaType.APPLICATION_JSON))
  ...
  void getPaymentMethod() throws Exception {
    ...
    mvc.perform(get("/payment-methods/PAYPAL").contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
  ...
  void deletePaymentMethod() throws Exception {
    ...
    mvc.perform(delete("/payment-methods/PAYPAL").contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
  }
